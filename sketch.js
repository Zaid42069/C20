...
if (path.y>width/2) {
  ...
  if (treasureCollection>=1000) {
    text("congrats on reaching this far !!!!!!!!!!",width-400,height/2)
    }

    if (treasureCollection>=1500) {
      text("there's nothing more .",width-400,height/2)
    }

    if (treasureCollection>=2000) {
      text("https://www.youtube.com/shorts/eNQDkeoCNxw",width-450,height/2)
      }
  }
