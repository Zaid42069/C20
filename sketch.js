...
if (path.y>width/2) {
  ...
  if (treasureCollection>=1000) {
    text("congrats on reaching this far !!!!!!!!!!",width-300,height/2)
    }

    if (treasureCollection>=1500) {
      text("there's nothing more .give up on your derams and die",width/2,height/2)
    }

    if (treasureCollection>=2000) {
      text("https://www.youtube.com/shorts/eNQDkeoCNxw",width/2,height/2)
      }
  }
